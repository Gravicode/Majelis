...
namespace Majelis.Data
{
    ...
    {
        public static string UploadUrlPrefix = "https://storagemurahaje.blob.core.windows.net/Majelis";
        public const int FACE_WIDTH = 180;
        public const int FACE_HEIGHT = 135;
        public const string AppName = "Majelis";
        ...
        public static string EmailAccount = "Majelis@gmail.com";
